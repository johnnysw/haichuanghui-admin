...
// 题型相关图标
import GovernmentLine from "@iconify-icons/ri/government-line";
import Building2Line from "@iconify-icons/ri/building-2-line";
...
// 添加题型相关图标
addIcon("ri:government-line", GovernmentLine);
addIcon("ri:building-2-line", Building2Line);
