...
export const getUserList = (data?: User.QueryParams) => {
  return http.request<PageResponse<User.UserInfo>>(
    "get",
    "/api/v1/admin/users",
    { params: data }
  );
...
export const addUser = (data: User.FormData) => {
  // 新增用户时，不返回密码（使用 Omit）
  return http.request<Response<Omit<User.UserInfo, "password">>>(
    "post",
    "/api/v1/admin/users",
    { data }
  );
...
export const resetPassword = (data: {
  ...
  return http.request<Response>(
    "put",
    `/api/v1/admin/users/${data.userId}/password`,
...
export const getAssignableRoles = () => {
  return http.request<Response<Role.BaseRole[]>>(
    "get",
...
export const getRoleIds = (data: { userId: number }) => {
  return http.request<Response<Role.BaseRole[]>>(
    "get",
    `/api/v1/admin/users/${data.userId}/roles`
  );
};
...
export const getRoleList = (data?: Role.QueryParams) => {
  return http.request<PageResponse<Role.BaseRole>>(
    "get",
    "/api/v1/admin/roles",
    { params: data }
  );
...
export const addRole = (data: Role.FormData) => {
  return http.request<Response<Role.BaseRole>>("post", "/api/v1/admin/roles", {
    data
  });
};
...
export const updateRoleStatus = (data: { id: number; status: 0 | 1 }) => {
  return http.request<Response>(
    "put",
    `/api/v1/admin/roles/${data.id}/status`,
    { data }
  );
};
...
export const saveRoleMenus = (data: { roleId: number; menuIds: number[] }) => {
  return http.request<Response>(
    "put",
    `/api/v1/admin/roles/${data.roleId}/menus`,
    { data }
  );
};
...
export const getMenuList = (data?: Menu.QueryParams) => {
  return http.request<Response<Menu.BaseMenu[]>>("get", "/api/v1/admin/menus", {
    params: data
  });
};
...
export const addMenu = (data: Menu.FormData) => {
  return http.request<Response<Menu.BaseMenu>>("post", "/api/v1/admin/menus", {
    data
  });
};
...
export const updateMenu = (data: Menu.FormData) => {
  return http.request<Response<Menu.BaseMenu>>(
    "put",
    `/api/v1/admin/menus/${data.id}`,
    { data }
  );
};
...
export const getDeptList = (data?: Dept.QueryParams) => {
  return http.request<Response<Dept.BaseDept[]>>("get", "/api/v1/admin/depts", {
    params: data
  });
};
...
export const updateDept = (data: Dept.FormData) => {
  return http.request<Response>("put", `/api/v1/admin/depts/${data.id}`, {
    data
  });
};
...
export const getOnlineLogsList = (data?: Log.OnlineUser) => {
  return http.request<PageResponse<Log.LoginLog>>("post", "/online-logs", {
    data
  });
};
...
export const getLoginLogsList = (data?: Log.LoginLog) => {
  return http.request<PageResponse<Log.LoginLog>>("post", "/login-logs", {
    data
  });
};
...
export const getOperationLogsList = (data?: Log.OperationLog) => {
  return http.request<PageResponse<Log.OperationLog>>(
    "post",
    "/operation-logs",
    { data }
  );
...
export const getSystemLogsList = (data?: Log.SystemLog) => {
  return http.request<PageResponse<Log.SystemLog>>(
    "get",
...
export const getSystemLogsDetail = (data?: { id: number }) => {
  return http.request<PageResponse<Log.SystemLog>>(
    "get",
    `/api/v1/admin/system/logs/${data?.id}`
  );
};
...
export const getTenantPackageMenuIds = (data?: object) => {
  return http.request<PageResponse>("post", "/tenant-package-menu-ids", {
    data
  });
};
