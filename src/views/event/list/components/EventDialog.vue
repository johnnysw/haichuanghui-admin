      ...
      <div class="mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <el-form-item label="活动类型" prop="type">
            <el-select v-model="form.type" placeholder="请选择活动类型" class="w-full">
          ...
          <el-form-item label="最大参与人数">
            <el-input-number v-model="form.maxParticipants" :min="1" class="w-full" />
          </el-form-item>
        </div>
...
const dialogTitle = computed(() => {
  switch (props.mode) {
    case "add": return "新增活动";
    case "edit": return "编辑活动";
    case "view": return "查看活动";
    default: return "";
  }
});
