  ...
  <div class="bg-white">
    <div class="px-6 py-4">
      <el-tabs v-model="currentTab" @tab-change="handleTabChange">
          ...
          <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div v-if="event.agenda" class="bg-gray-50 rounded-lg p-4">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">{{ event.agenda }}</p>
              </div>
              ...
              <div v-if="event.requirements" class="bg-gray-50 rounded-lg p-4">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">{{ event.requirements }}</p>
              </div>
              ...
              <div v-if="event.benefits" class="bg-gray-50 rounded-lg p-4">
                ...
                <p class="text-sm text-gray-600 leading-relaxed">{{ event.benefits }}</p>
              </div>
            </div>
        ...
        <!-- 嘉宾介绍 -->
        <el-tab-pane label="嘉宾介绍" name="speakers" v-if="event.speakers && event.speakers.length > 0">
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              ...
              <div v-if="speaker.bio">
                ...
                <p class="text-xs text-gray-600 leading-relaxed">{{ speaker.bio }}</p>
              </div>
            </div>
          </div>
        </el-tab-pane>
        ...
        <!-- 赞助商 -->
        <el-tab-pane label="赞助商" name="sponsors" v-if="event.sponsors && event.sponsors.length > 0">
          <!-- 按级别分组显示 -->
          <div class="space-y-8">
              ...
              <div v-if="getSponsorsByLevel(level.key).length > 0">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
                  <div
                    ...
                    class="text-center"
                  >
                    <div class="bg-gray-50 rounded-lg p-4 mb-2 hover:bg-gray-100 transition-colors">
                      <el-image
                        :src="sponsor.logo"
                        :alt="sponsor.name"
                    ...
                    <p v-if="sponsor.description" class="text-xs text-gray-600">{{ sponsor.description }}</p>
                    <el-button
        ...
        <!-- 活动资料 -->
        <el-tab-pane label="活动资料" name="materials" v-if="event.materials && event.materials.length > 0">
              ...
              <div class="flex items-start gap-3">
                ...
                <div class="flex-shrink-0">
                  <el-icon size="32" :color="getFileIconColor(material.type)">
                    <component :is="useRenderIcon(getFileIcon(material.type))" />
                  </el-icon>
                </div>

                <!-- 文件信息 -->
                <div class="flex-1 min-w-0">
                  <h4 class="font-medium text-gray-900 truncate">{{ material.name }}</h4>
                  ...
                  <div class="flex items-center gap-4 mt-2 text-xs text-gray-500">
                    ...
                    <span v-if="material.downloadCount">下载: {{ material.downloadCount }}次</span>
                  </div>
                </div>
        ...
        <!-- 活动图片 -->
        <el-tab-pane label="活动图片" name="gallery" v-if="event.gallery && event.gallery.length > 0">
          <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
            ...
            >
              <el-image
                ...
                :initial-index="event.gallery!.findIndex(g => g.id === image.id)"
                preview-teleported
              />
            </div>
          </div>
            ...
            <div class="bg-gray-50 rounded-lg p-6">
              ...
              <div class="space-y-3">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <el-button link type="primary" @click="callPhone(event.contactPhone)">
                    {{ event.contactPhone }}
                  </el-button>
                </div>
                <div class="flex items-center gap-3">
                  ...
                  <el-button link type="primary" @click="sendEmail(event.contactEmail)">
                    {{ event.contactEmail }}
                  </el-button>
                </div>
                <div v-if="event.website" class="flex items-center gap-3">
                  ...
                  <el-button link type="primary" @click="openLink(event.website!)">
                    {{ event.website }}
                  </el-button>
                </div>
                <div class="flex items-start gap-3">
...
const getFileIcon = (type: string) => {
  switch (type) {
    ...
    case "video": return "ep:video-play";
    case "image": return "ep:picture";
    case "link": return "ep:link";
...
const getFileIconColor = (type: string) => {
  switch (type) {
    ...
    case "image": return "#fa8c16";
    case "link": return "#722ed1";
