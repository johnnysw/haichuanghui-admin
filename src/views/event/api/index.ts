...
const mockEventData: EventItem[] = [
  {
    ...
    description: "邀请知名创业导师和成功企业家分享创业经验，为创业者提供实用的创业指导和方法论。本次活动将深入探讨创业项目的商业模式设计、团队建设、融资策略等关键环节。",
    ...
    status: 1,
    isRecommended: true,
    coverImage: "https://via.placeholder.com/400x300/4285f4/ffffff?text=创业大讲堂",
  ...
  },
  {
    ...
    description: "汇聚优秀创业项目和投资机构，为创业者提供展示平台，促进项目与资本的有效对接。活动将邀请多家知名投资机构和创业导师现场点评。",
    ...
    status: 1,
    isRecommended: true,
    coverImage: "https://via.placeholder.com/400x300/34a853/ffffff?text=路演大会",
  ...
  },
  {
    id: 3,
    title: "数字化转型创业训练营",
    description: "针对传统行业数字化转型需求，提供系统性的创业培训课程。课程涵盖数字化商业模式、技术应用、运营管理等多个维度。",
  ...
  },
  {
    id: 4,
    title: "最新创业扶持政策解读会",
    description: "邀请政府相关部门负责人详细解读最新的创业扶持政策，包括税收优惠、资金补贴、场地支持等具体政策内容和申请流程。",
    ...
    status: 1,
    isRecommended: false,
    coverImage: "https://via.placeholder.com/400x300/ea4335/ffffff?text=政策解读",
  ...
  },
  {
    id: 5,
    title: "投融资对接交流会",
    description: "搭建创业项目与投资机构的交流平台，促进优质项目与资本的精准对接。活动将采用一对一洽谈的形式，提高对接效率。",
    ...
    status: 2,
    isRecommended: false,
    coverImage: "https://via.placeholder.com/400x300/9c27b0/ffffff?text=投融资对接",
...
// 获取活动列表
export const getEventList = (params: EventListParams): Promise<ApiResponse<PaginationResponse<EventItem>>> => {
...
// 创建活动
export const createEvent = (data: EventCreateForm): Promise<ApiResponse<EventItem>> => {
  return new Promise((resolve) => {
    setTimeout(() => {
...
// 更新活动
export const updateEvent = (id: number, data: Partial<EventCreateForm>): Promise<ApiResponse<EventItem>> => {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
