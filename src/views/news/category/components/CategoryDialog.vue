    ...
    >
      ...
      <div class="mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <el-form-item label="父级分类" prop="parentId">
            <el-select v-model="form.parentId" placeholder="请选择父级分类（可选）" class="w-full">
      ...
      <div class="mb-6">
        ...
        <el-form-item label="分类图标" prop="icon">
          <div class="w-full">
            <el-select v-model="form.icon" placeholder="请选择分类图标" class="w-full">
      ...
      <div v-if="mode === 'view' && formData" class="mb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">分类ID</label>
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">文章数量</label>
            <div class="text-blue-600 font-medium">{{ formData.articleCount }}</div>
          </div>
          <div>
          ...
          <div>
            ...
            <div class="text-gray-900">{{ formatDateTime(formData.createdTime) }}</div>
          </div>
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">更新时间</label>
            <div class="text-gray-900">{{ formatDateTime(formData.updatedTime) }}</div>
          </div>
        </div>
        <div v-if="formData.reviewComment" class="mt-4">
          <label class="block text-sm font-medium text-gray-700 mb-1">审核意见</label>
          <div class="bg-gray-50 p-3 rounded text-gray-900">{{ formData.reviewComment }}</div>
        </div>
      </div>
    </el-form>
...
const dialogTitle = computed(() => {
  switch (props.mode) {
    case "add": return "新增分类";
    case "edit": return "编辑分类";
    case "view": return "查看分类";
    default: return "";
  }
});
...
// 图标选项
const iconOptions = [
  { value: "ri:calendar-event-line", label: "活动", icon: "ri:calendar-event-line" },
  ...
  { value: "ri:money-dollar-circle-line", label: "投资", icon: "ri:money-dollar-circle-line" },
  ...
  { value: "ri:graduation-cap-line", label: "教育", icon: "ri:graduation-cap-line" },
