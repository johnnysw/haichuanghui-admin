<template>
  <div class="project-detail-page">
        ...
        <template #extra>
          ...
          >
            ...
            <el-button
              ...
              :icon="
                useRenderIcon(
                  projectDetail.isRecommended ? 'ep:star-filled' : 'ep:star'
                )
              "
            ...
            <div class="flex justify-between items-start">
              <div class="flex-1">
                <h1 class="text-2xl font-bold text-gray-800 mb-2">
                  {{ projectDetail.title || projectDetail.name }}
                </h1>
                <p class="text-gray-500 mb-3">
                  企业名称：<span class="font-medium">{{
                ...
                <div class="flex flex-wrap gap-2 mb-3">
                  ...
                  <el-tag v-if="projectDetail.isRecommended" type="warning">
                    推荐项目
                  </el-tag>
                </div>
      ...
      <div class="flex flex-wrap lg:flex-nowrap gap-8">
          ...
          <div class="bg-white rounded-lg shadow-md mb-6">
            <el-tabs v-model="activeTab" class="project-tabs">
                ...
                <div class="space-y-6">
                  ...
                  <div>
                    ...
                    <div
                      ...
                      v-html="
                        processContent(projectDetail.shortDescription || '')
                      "
                    />
                    <p
                      v-if="!projectDetail.shortDescription"
                      class="text-gray-400"
                    >
                      暂无项目简介
                    </p>
                  ...
                  <div>
                    ...
                    <div
                      class="content-styles"
                      v-html="processContent(projectDetail.introduction || '')"
                    />
                    <p v-if="!projectDetail.introduction" class="text-gray-400">
                      暂无项目详情
                    </p>
                  </div>
                </div>
              ...
              <el-tab-pane label="团队介绍" name="team">
                ...
                <div
                  v-if="projectDetail.teamInfo"
                  class="content-styles"
                  v-html="processContent(projectDetail.teamInfo)"
                />
              ...
              <el-tab-pane label="融资历史" name="funding">
                ...
                <div
                  v-if="projectDetail.fundingHistory"
                  class="content-styles"
                  v-html="processContent(projectDetail.fundingHistory)"
                />
              ...
              <el-tab-pane label="核心技术" name="technology">
                ...
                <div
                  v-if="projectDetail.coreTechnology"
                  class="content-styles"
                  v-html="processContent(projectDetail.coreTechnology)"
                />
              ...
              <el-tab-pane label="商业模式" name="business">
                ...
                <div
                  v-if="projectDetail.businessModel"
                  class="content-styles"
                  v-html="processContent(projectDetail.businessModel)"
                />
              ...
              <el-tab-pane label="市场分析" name="market">
                ...
                <div
                  v-if="projectDetail.marketAnalysis"
                  class="content-styles"
                  v-html="processContent(projectDetail.marketAnalysis)"
                />
              ...
              <el-tab-pane label="竞争优势" name="advantage">
                ...
                <div
                  v-if="projectDetail.competitiveAdvantage"
                  class="content-styles"
                  v-html="processContent(projectDetail.competitiveAdvantage)"
                />
              ...
              <el-tab-pane label="发展规划" name="plan">
                ...
                <div
                  v-if="projectDetail.developmentPlan"
                  class="content-styles"
                  v-html="processContent(projectDetail.developmentPlan)"
                />
        ...
        <div class="w-full lg:w-1/3">
            ...
            <div class="space-y-3">
              <div class="flex items-center">
                ...
                <span class="font-medium">{{
                  projectDetail.contactPerson || "暂无数据"
                }}</span>
              </div>
              <div class="flex items-center">
                <span class="w-20 text-gray-500">职位:</span>
                <span class="font-medium">{{
                  projectDetail.contactPosition || "暂无数据"
                }}</span>
              </div>
              <div class="flex items-center">
                <span class="w-20 text-gray-500">手机:</span>
                <span class="font-medium">{{
                  projectDetail.contactPhone || "暂无数据"
                }}</span>
              </div>
              <div class="flex items-center">
                <span class="w-20 text-gray-500">邮箱:</span>
                <span class="font-medium">{{
                  projectDetail.contactEmail || "暂无数据"
                }}</span>
              </div>
              <div class="flex items-center">
                <span class="w-20 text-gray-500">地址:</span>
                <span class="font-medium">{{
                  projectDetail.address || projectDetail.location || "暂无数据"
                }}</span>
              </div>
            </div>
            <div
              v-if="projectDetail.website"
          ...
          <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div
              v-if="
                projectDetail.businessPlanFile || projectDetail.businessPlanUrl
              "
            ...
            >
              ...
              <div
                ...
                style="min-width: 0; white-space: nowrap"
              >
                <p
                ...
                <p class="text-xs text-gray-400 mt-1">
                  更新于：{{
                    formatDate(
                      projectDetail.businessPlanFile?.createdTime ||
          ...
          <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            ...
            <div
              v-if="
                projectDetail.presentationFile || projectDetail.presentationUrl
              "
              class="bg-gray-50 border border-gray-200 rounded-lg p-4"
              style="
                display: grid;
            ...
            >
              ...
              >
                ...
                <p class="text-xs text-gray-400 mt-1">
                  更新于：{{
                    formatDate(
                      projectDetail.presentationFile?.createdTime ||
                        projectDetail.updatedAt
                    )
                  }}
                </p>
          ...
          <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="pb-4 mb-4 border-b border-gray-200">
              <div class="grid grid-cols-2 gap-4 mb-3">
                ...
                <div>
                  ...
                  <p class="font-medium text-sm">
                    {{ formatDateTime(projectDetail.updatedAt) }}
                  </p>
                </div>
              </div>
              <div v-if="projectDetail.creator">
                ...
                <p class="font-medium text-sm">
                  {{
                    projectDetail.creator.nickname ||
            ...
            <div
              v-if="
                projectDetail.reviewer ||
                projectDetail.reviewTime ||
                projectDetail.reviewComment
              "
            >
              <div class="grid grid-cols-2 gap-4 mb-3">
                <div v-if="projectDetail.reviewer">
                  ...
                  <p class="font-medium text-sm">
                    {{
                      projectDetail.reviewer.nickname ||
                      projectDetail.reviewer.username
                    }}
                  </p>
                </div>
                <div v-if="projectDetail.reviewTime">
                  ...
                  <p class="font-medium text-sm">
                    {{ formatDateTime(projectDetail.reviewTime) }}
                  </p>
                </div>
              </div>
    ...
    <!-- 融资需求详情弹窗 -->
    <el-dialog v-model="showFundingNeedsDialog" title="融资需求" width="600px">
    ...
    <!-- 审核对话框 -->
    <el-dialog v-model="reviewDialogVisible" title="审核项目" width="500px">
      <el-form
        ref="reviewFormRef"
        :model="reviewForm"
        :rules="reviewRules"
...
const projectTags = ref<
  Array<{ id: number; name: string; style: ReturnType<typeof getTagStyle> }>
>([]);
...
const handleDownloadBusinessPlan = () => {
  ...
  // 否则尝试使用URL
  const fileUrl =
    file?.url || file?.filePath || projectDetail.value?.businessPlanUrl;
  if (fileUrl) {
...
const handleDownloadPresentation = () => {
  ...
  // 否则尝试使用URL
  const fileUrl =
    file?.url || file?.filePath || projectDetail.value?.presentationUrl;
  if (fileUrl) {
    window.open(normalizeFileUrl(fileUrl), "_blank");
    return;
  }
...
const handleToggleRecommend = async () => {
  ...
  try {
    const result = await toggleProjectRecommendation(projectDetail.value.id, {
      isRecommended: !projectDetail.value.isRecommended
    });
    if (result.code === 200) {
      ElMessage.success(
        projectDetail.value.isRecommended ? "已取消推荐" : "推荐成功"
      );
      projectDetail.value = result.data;
    } else {
